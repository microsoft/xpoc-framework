...
/*
    ...
    Becomes this:
        import Formats from \"ajv-formats/dist/formats\";
...
moduleCode = moduleCode
    .replace(/exports.Manifest\s*=\s*validate(\d+);/, "import Formats from \"ajv-formats/dist/formats.js\";const { fullFormats } = Formats;export { validate$1 as Manifest };")
